...
extern "C" void app_main()
{
    ...
    ESP_LOGI(TAG, "Using config: WW=GPIO%d CW=GPIO%d CCT=%d-%d mireds",
             config->ww_gpio, config->cw_gpio, config->color_temp_min, config->color_temp_max);
    ...
    light_config.color_control.color_mode =
        static_cast<uint8_t>(ColorControl::ColorModeEnum::kColorTemperatureMireds);
    light_config.color_control.enhanced_color_mode =
        static_cast<uint8_t>(ColorControl::ColorModeEnum::kColorTemperatureMireds);
    light_config.color_control.color_capabilities = 0x10;  // ColorTemperature feature
    light_config.color_control_color_temperature.color_temperature_mireds = TLED_DEFAULT_COLOR_TEMP;
    light_config.color_control_color_temperature.color_temp_physical_min_mireds = MATTER_COLOR_TEMP_MIN;
    light_config.color_control_color_temperature.color_temp_physical_max_mireds = MATTER_COLOR_TEMP_MAX;
